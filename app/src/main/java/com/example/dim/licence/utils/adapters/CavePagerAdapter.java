...
public class CavePagerAdapter extends FragmentStatePagerAdapter {

    private CaveActivity parentActivity;

    public CavePagerAdapter(CaveActivity activity, FragmentManager fm) {
        super(fm);
...
// 2 pages
        if (parentActivity.getCurrentPage() == 1) {
            if (object.getClass().getSimpleName().equalsIgnoreCase("CaveListFragment")) {
                return 0;
            } else if (object.getClass().getSimpleName().equalsIgnoreCase("CaveDetailFragment")) {
                return 1;
            } else {
                return POSITION_NONE;
            }
...
// 3 pages
        if (parentActivity.getCurrentPage() == 2) {
            ...
            if (object.getClass().getSimpleName().equalsIgnoreCase("CaveDetailFragment")) {
                return 1;
            }

            if (object.getClass().getSimpleName().equalsIgnoreCase("CaveEditFragment")) {
                return 2;
            }
        }
