...
public class DbHelper {
    ...
    public static final String CREATE_TABLE_GEOLOCALISATION = "CREATE TABLE " + TABLE_GEOLOCALISATION + " ("
            + KEY_ID +" INTEGER PRIMARY KEY AUTOINCREMENT, "
            + KEY_GEOLOC_PAYS + " TEXT(200), "
            + KEY_GEOLOC_VILLE + " TEXT(200), "
            + KEY_GEOLOC_CODE + " TEXT(200), "
            + KEY_GEOLOC_ADRESSE + " TEXT(200));";
    ...
    public static final String CREATE_TABLE_HISTORIQUE = "CREATE TABLE " + TABLE_HISTORIQUE + " ("
            ...
            + KEY_HISTORIQUE_DATE + " TEXT(200), "
            + KEY_HISTORIQUE_ETAT + " BOOLEAN, "
    ...
    public static final String CREATE_TABLE_VIGNERON = "CREATE TABLE " + TABLE_VIGNERON + " ("
            ...
            + KEY_VIGNERON_DOMAINE + " TEXT(200), "
            + KEY_VIGNERON_GEOLOCALISATION + " INTEGER, "
            + KEY_VIGNERON_FIXE + " TEXT(20), "
            + KEY_VIGNERON_MOBILE + " TEXT(20), "
            + KEY_VIGNERON_MAIL + " TEXT(200), "
            + KEY_VIGNERON_FAX + " TEXT(20), "
            + KEY_VIGNERON_COMMENTAIRE + " TEXT(500), "
    ...
    public static final String CREATE_TABLE_VIN = "CREATE TABLE " + TABLE_VIN + " ("
            ...
            + KEY_VIN_FAVORIS + " BOOLEAN, "
            + KEY_VIN_TYPE + " INTEGER, "
            + KEY_VIN_PRIX + " REAL, "
            + KEY_VIN_QUANTITE + " INTEGER, "
            + KEY_VIN_ANNEE + " TEXT(4), "
            + KEY_VIN_ANNEEMAX + " TEXT(4), "
            + KEY_VIN_VIGNERON + " INTEGER, "
            + KEY_VIN_COMMENTAIRE + " TEXT(500), "
